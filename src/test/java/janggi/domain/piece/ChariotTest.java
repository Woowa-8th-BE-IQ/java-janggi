...
class ChariotTest {
    ...
    void canMove_PathBlocked_ThrowsException() {
        Chariot chariot = new Chariot(Team.HAN);
        Path blockedPath = new Path(List.of(new Soldier(Team.HAN)));
    ...
    void canMove_TargetIsSameTeam_ThrowsException() {
        Chariot chariot = new Chariot(Team.HAN);
        Path clearPath = new Path(List.of(new EmptyPiece()));
    ...
    void canMove_ValidPathAndTarget_DoesNotThrow() {
        Chariot chariot = new Chariot(Team.HAN);
        Path clearPath = new Path(List.of(new EmptyPiece(), new EmptyPiece()));
