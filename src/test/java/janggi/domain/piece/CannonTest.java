...
class CannonTest {
    ...
    void canMove_InvalidJumpCount_ThrowsException() {
        Cannon cannon = new Cannon(Team.HAN);
        Path emptyPath = new Path(List.of(new EmptyPiece(), new EmptyPiece()));
        Path noPath = new Path(List.of());
        Path tooManyPiecesPath = new Path(List.of(new Soldier(Team.HAN), new Elephant(Team.HAN)));
    ...
    void canMove_JumpOverCannon_ThrowsException() {
        Cannon cannon = new Cannon(Team.HAN);
        Path pathWithCannon = new Path(List.of(new EmptyPiece(), new Cannon(Team.HAN)));
        Piece targetPiece = new EmptyPiece();
    ...
    void canMove_TargetIsCannon_ThrowsException() {
        Cannon cannon = new Cannon(Team.HAN);
        Path validJumpPath = new Path(List.of(new Guard(Team.HAN)));
    ...
    void canMove_ValidJumpAndTarget_DoesNotThrow() {
        Cannon cannon = new Cannon(Team.HAN);
        Path validJumpPath = new Path(List.of(new EmptyPiece(), new Soldier(Team.HAN)));
